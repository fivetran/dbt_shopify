...
| [shopify__products](https://fivetran.github.io/dbt_shopify/#!/model/model.shopify.shopify__products) or<br>[shopify_gql__products](https://fivetran.github.io/dbt_shopify/#!/model/model.shopify.shopify_gql__products) | New Columns | Metafields not included | `PRODUCT` metafields included | Can be disabled by setting the `shopify_using_product_metafields`, `shopify_using_collection_metafields`, and `shopify_using_all_metafields` variables to False. |
