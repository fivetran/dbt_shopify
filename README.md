...
| [shopify__refunds](https://fivetran.github.io/dbt_shopify/#!/model/model.shopify.shopify__refunds) or<br>[shopify_gql__refunds](https://fivetran.github.io/dbt_shopify/#!/model/model.shopify.shopify_gql__refunds) | Line-item level refund detail joined with order and product context, including restock classification, refund timing, and refund discrepancy adjustments. <br><br>**Example Analytics Questions:**<br>• What is the average time between order creation and refund processing by product category?<br>• Which products have the highest return rates and what are the most common restock types? |
| [shopify__refund_lines](https://fivetran.github.io/dbt_shopify/#!/model/model.shopify.shopify__refund_lines) or<br>[shopify_gql__refund_lines](https://fivetran.github.io/dbt_shopify/#!/model/model.shopify.shopify_gql__refund_lines) | Refund line item detail at the most granular level, exposing per-line refund financials, product context, and restock classification. <br><br>**Example Analytics Questions:**<br>• What is the total refund amount by product variant and restock type?<br>• Which order lines have the highest refund rates and what are the associated refund reasons? |
