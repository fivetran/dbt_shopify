...
with calendar as (
    ...
    {% set partition_string = 'partition by customer_id ' ~ fivetran_utils.partition_by_source_relation(package_name='shopify') ~ 'order by date_month rows between unbounded preceding and current row' %}
