{{ config(enabled=(var('shopify__standardized_billing_model_enabled', True) and var('shopify_api', 'rest') == var('shopify_api_override','graphql'))) }}
...
with line_items as (
    ...
    select
        ...
        li.unit_price_shop_amount as unit_amount,
