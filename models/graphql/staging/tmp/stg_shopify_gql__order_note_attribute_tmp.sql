...
{{
    shopify.shopify_union_data(
        ...
        default_variable='gql_order_custom_attribute_source' if var('shopify_gql_using_order_custom_attribute', shopify.does_table_exist('order_custom_attribute', 'shopify_graphql')) else 'gql_order_note_attribute_source', 
