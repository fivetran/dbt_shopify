...
{{
    shopify.shopify_union_data(
        ...
        default_variable='gql_order_line_tax_line_source' if var('shopify_gql_using_refund_line_item', shopify.does_table_exist('order_line_tax_line', 'shopify_graphql')) else 'gql_tax_line_source', 
